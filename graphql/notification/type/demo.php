...
class demo extends \phpbb\notification\type\base
{
	...
	{
		return 'buddhalow.graphql.notification.type.demo';
	}
	...
	{
		return $this->helper->route('buddhalow_graphql_controller', $this->get_data('acme_demo'));
	}
